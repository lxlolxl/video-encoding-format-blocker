(() => {
  'use strict';
  const BLOCKED_CODECS = Object.freeze(['av1', 'vp9', 'hevc']);
  ...
  const tests = { av1: [/(^|[^a-z0-9])av01([.\s,;"']|$)/i, /(^|[^a-z0-9])av1([^a-z0-9]|$)/i], vp9: [/(^|[^a-z0-9])vp09([.\s,;"']|$)/i, /(^|[^a-z0-9])vp9([^a-z0-9]|$)/i], hevc: [/(^|[^a-z0-9])hvc1([.\s,;"']|$)/i, /(^|[^a-z0-9])hev1([.\s,;"']|$)/i, /(^|[^a-z0-9])hevc([^a-z0-9]|$)/i, /(^|[^a-z0-9])h265([^a-z0-9]|$)/i, /(^|[^a-z0-9])h\.265([^a-z0-9]|$)/i, /(^|[^a-z0-9])dvh1([.\s,;"']|$)/i, /(^|[^a-z0-9])dvhe([.\s,;"']|$)/i] };
